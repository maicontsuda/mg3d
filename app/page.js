...
export default function Home() {
  ...
  return <main>
    ...
    <header className="site-header">
      <a className="brand" href="#top" aria-label="MG3D início"><img className="brand-logo" src="/logo-mg.webp" alt="MG 3D Print" /><span>MG<span>3D</span><small>PRINT LAB</small></span></a>
