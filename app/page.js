...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      <div className="hero-copy"><p className="eyebrow"><span></span> Design que sai da tela</p><p className="hero-slogan">Inovação Em Cada Camada</p><h1>Objetos que<br /><i>ganham forma.</i></h1><p className="hero-text">Peças autorais impressas em 3D para deixar seus espaços mais funcionais, mais bonitos e muito mais seus.</p><a className="button button-dark" href="#colecao">Explorar coleção <Icon name="arrow" size={17} /></a><div className="hero-note"><div className="avatar-stack"><span>✦</span><span>◌</span><span>✳</span></div><span>Feito em pequenos lotes<br /><strong>por quem acredita no detalhe.</strong></span></div></div>
